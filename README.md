...
`valve-on-android` is a Termux tool that uses [TermuxDepotDownloader](https://github.com/AruMoon/TermuxDepotDownloader) by [TheKingFireS](https://github.com/TheKingFireS)
